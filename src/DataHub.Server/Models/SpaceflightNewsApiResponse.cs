...
/// </summary>
public partial class SpaceflightNewsApiResponse : IApiResponse<News>
{
    /// <summary>
    ...
    public ApiClientData<News> ToData(string apiProvider)
        => ApiClientData<News>.Success(
            apiProvider,
            data: Results?.Count > 0 ? Results.Select(x => new News
            {
                Title = x.Title,
