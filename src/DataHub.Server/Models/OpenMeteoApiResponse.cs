...
/// </summary>
public partial class OpenMeteoApiResponse : IApiResponse<Weather>
{
    /// <summary>
    ...
    public ApiClientData<Weather> ToData(string apiProvider)
    {
        var tempsPerDate = Daily?.Time.Zip(Daily?.Temperature2MMax, (date, temperature) => (date, temperature));
        return ApiClientData<Weather>.Success(
            apiProvider,
