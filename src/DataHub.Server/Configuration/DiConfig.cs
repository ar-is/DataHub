...
{
    /// <summary>
    /// Adds authentication options to the specified <see cref="IServiceCollection"/> using the provided configuration.
    /// </summary>
    /// <param name="services">The <see cref="IServiceCollection"/> to add the authentication services to.</param>
    /// <param name="configuration">The configuration from which to load authentication options.</param>
    /// <returns>The modified <see cref="IServiceCollection"/> so that additional method calls can be chained.</returns>
    ...
    public static IServiceCollection AddExternalApis(this IServiceCollection services, IConfiguration configuration)
        => services
            .Configure<ExternalApiOptions>(configuration.GetSection(ExternalApiOptions.GeneralOptionsName))
    ...
    private static IServiceCollection AddNewsApis(this IServiceCollection services, IConfiguration configuration)
        => services
            .AddTransient<IDataProviderService<News>, DataProviderService<News>>()
    ...
    private static IServiceCollection AddBooksApis(this IServiceCollection services, IConfiguration configuration)
        => services
            .AddTransient<IDataProviderService<Book>, DataProviderService<Book>>()
